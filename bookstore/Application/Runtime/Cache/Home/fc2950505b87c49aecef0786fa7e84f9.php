...
<head>
	...
	<link rel="stylesheet" href="/bookstore1/Public/Home/css/header.css">
	<link rel="stylesheet" href="/bookstore1/Public/Home/css/footer.css">
	<link rel="stylesheet" href="/bookstore1/Public/Home/css/index.css">
	<link rel="stylesheet" href="/bookstore1/Public/Home/css/details.css">
</head>
<body>
	<div class="meun">
	...
	<div class="img">
		<img src="/bookstore1/Public/Home/images/258.jpg" alt="">
	</div>
	<div class="tree">
	...
	<div class="show">
		<img src="/bookstore1/Public/Home/image/history.jpg" alt="">
	</div>
	<div class="jianjie">
...
<div class="footer">
	...
	<div class="footer_top">
		<ul>
			<li><a href=""><img src="/bookstore1/Public/Home/image/img1.png" alt=""></a></li>
			<li><a href=""><img src="/bookstore1/Public/Home/image/img2.png" alt=""></a></li>
			<li><a href=""><img src="/bookstore1/Public/Home/image/img3.png" alt=""></a></li>
			<li><a href=""><img src="/bookstore1/Public/Home/image/img4.png" alt=""></a></li>
		</ul>
	</div>
	<div class="about">
		<ul>
	...
	<div class="link">
		...
		<div class="xukezhengpic">
			<img src="/bookstore1/Public/Home/image/xukezheng.png" alt="">
		</div>
	</div>
</div>


<script src="/bookstore1/Public/Home/JS/jquery-1.11.1.js"></script>
<script src="/bookstore1/Public/Home/JS/jquery-1.8.0.js"></script>
<script src="/bookstore1/Public/Home/JS/jquery.js"></script>
<script src="/bookstore1/Public/Home/JS/header.js"></script>
<script src="/bookstore1/Public/Home/JS/index.js"></script>
<script src="/bookstore1/Public/Home/JS/details.js"></script>
</body>
</html>